        ...
        <div class="container mx-auto flex flex-wrap">
            ...
            <div class="container px-2  mx-auto flex flex-wrap">
                @foreach($products as $product)
                    <div class="flex flex-row justify-left w-full items-center relative mb-2 bg-black">
                        <div class="w-full">
                            <img style="width:125px; height:115px" class="object-contain" src="{{$product->image}}"
                                 alt="">
                        </div>
                        <div class="px-5 w-full">
                            <a href="{{route('products.show',$product->id)}}"
                               class="text-orange-300 capitalize">{{$product->name}}</a>
                        </div>
                        <div>
