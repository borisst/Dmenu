    ...
    <div class="flex flex-wrap space-y-5 mx-auto relative justify-center">
        ...
        <div class="flex flex-wrap justify-center md:space-y-5 space-y-10">
            ...
            <div class="w-full rounded-lg border-2 border-gray-200 shadow-lg p-5">
                <form action="{{route('companies-company.update', $company)}}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex flex-col justify-center space-y-2">
                        <div class="mx-15">
                            ...
                            <input id="name" type="text" name="name" value="{{$company->name}}" class="w-2/3 px-2 p-1 rounded-lg capitalize mt-2">
                        </div>

                        <div>
                            <label for="contact_number" class="block">Contact Number</label>
                            <input id="contact_number" type="tel" name="contact_number" value="{{$company->contact_number}}" class="w-2/3 px-2 p-1 rounded-lg mt-2">
                        </div>
                        ...
                        <div class="flex flex-wrap justify-evenly">
                            <div>
                                ...
                                <input type="time" id="opens_at"   name="opens_at" value="{{$company->opens_at}}" class="px-2 p-1 rounded-lg mt-2">
                            </div>

                            <div>
                                <label for="closes_at" class="block">Closes at:</label>
                                <input type="time" id="closes_at" value="{{$company->closes_at}}" name="closes_at" class="px-2 p-1 rounded-lg mt-2">
                            </div>
                        </div>

                        <div>
                            <label for="fb_link" class="block">Facebook Profile</label>
                            <input id="fb_link" type="text" name="fb_link" value="{{$company->fb_link}}" class="w-full px-2 p-1 rounded-lg mt-2">
                        </div>

                        <div>
                            <label for="ig_link" class="block">Instagram Profile</label>
                            <input id="ig_link" type="text" name="ig_link" value="{{$company->ig_link}}" class="w-full px-2 p-1 rounded-lg mt-2">
                        </div>
